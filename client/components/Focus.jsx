...
const nodeStyle = {
  ...
  padding: 10, 
  borderRadius: 5,
  overflowY: 'auto',  // Use 'auto' for scroll only when needed
  background: 'white',
  textAlign: 'center',
}
// const listStyle = {
...
const CustomNode = ({ data }) => {
  return (
    <div style={nodeStyle}>
      <Handle type="target" position={Position.Left} animated={true} style={{ borderRadius: 5 }} />
      <h3>{data.label}</h3>
      <ul>
      ...
      <Handle type="source" position={Position.Right} animated={true} style={{ borderRadius: 5 }} />
    </div>
  );
}
